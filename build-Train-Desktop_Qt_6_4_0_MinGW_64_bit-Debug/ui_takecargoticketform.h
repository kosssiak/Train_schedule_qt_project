/********************************************************************************
** Form generated from reading UI file 'takecargoticketform.ui'
**
...
#ifndef UI_TAKECARGOTICKETFORM_H
#define UI_TAKECARGOTICKETFORM_H
...
public:
    ...
    void setupUi(QWidget *TakeCargoTicketForm)
    {
        if (TakeCargoTicketForm->objectName().isEmpty())
            TakeCargoTicketForm->setObjectName("TakeCargoTecketForm");
        TakeCargoTicketForm->resize(1059, 566);
        tableWidget = new QTableWidget(TakeCargoTicketForm);
        tableWidget->setObjectName("tableWidget");
        tableWidget->setGeometry(QRect(10, 50, 1041, 381));
        back = new QPushButton(TakeCargoTicketForm);
        ...
        font.setBold(true);
        back->setFont(font);
        label = new QLabel(TakeCargoTicketForm);
        label->setObjectName("label");
        label->setGeometry(QRect(360, 0, 361, 51));
        label->setFont(font);
        number = new QSpinBox(TakeCargoTicketForm);
        number->setObjectName("number");
        number->setGeometry(QRect(290, 500, 61, 41));
        number->setFont(font);
        spinBox = new QSpinBox(TakeCargoTicketForm);
        spinBox->setObjectName("spinBox");
        spinBox->setGeometry(QRect(230, 440, 61, 41));
        spinBox->setFont(font);
        submit = new QPushButton(TakeCargoTicketForm);
        submit->setObjectName("submit");
        submit->setGeometry(QRect(360, 450, 231, 41));
        submit->setFont(font);
        label_3 = new QLabel(TakeCargoTicketForm);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(20, 500, 261, 41));
        label_3->setFont(font);
        label_2 = new QLabel(TakeCargoTicketForm);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(20, 440, 191, 41));
        label_2->setFont(font);

        retranslateUi(TakeCargoTicketForm);

        QMetaObject::connectSlotsByName(TakeCargoTicketForm);
    } // setupUi

    void retranslateUi(QWidget *TakeCargoTicketForm)
    {
        TakeCargoTicketForm->setWindowTitle(QCoreApplication::translate("TakeCargoTecketForm", "Form", nullptr));
...
namespace Ui {
    class TakeCargoTicketForm: public Ui_TakeCargoTicketForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TAKECARGOTICKETFORM_H
